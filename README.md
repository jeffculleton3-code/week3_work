...
Once hello_mpi runs with around 8 processes, the sum of the user and system time starts to exceed the real time which indicates parallel processing is occurring. 
